...
- The app can be reached by the [link](https://artisticedge-f8cc7b427f4c.herokuapp.com/).
...
3. Go back to your local repository.

4. Login to your Heroku account in your terminal and connect your local repository to your heroku app.

    - ```heroku login -i``` - Enter all your Heroku credentials it will ask for.
    - Paste the command you copied from step 3 into your terminal.

5. Create Procfile and add the following to Procfile:

    - ```web: gunicorn yourappname.wsgi --log-file -``` - be sure to add your own appname.
